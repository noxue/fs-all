...
/* Define to 1 if you have the <tif_dir.h> header file. */
/* #undef HAVE_TIF_DIR_H */
...
#define PACKAGE_STRING "spandsp 3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "spandsp"
...
/* Support T.43 JBIG gray and colour compression */
/* #undef SPANDSP_SUPPORT_T43 */

/* Support TIFF/FX in TIFF file handling */
/* #undef SPANDSP_SUPPORT_TIFF_FX */

/* Support the V.32bis modem */
/* #undef SPANDSP_SUPPORT_V32BIS */

/* Support the V.34 FAX modem */
/* #undef SPANDSP_SUPPORT_V34 */

/* Use the NEON instruction set (ARMV7 only). */
/* #undef SPANDSP_USE_ARM_NEON */

/* Use the AVX instruction set (i386 and x86_64 only). */
/* #undef SPANDSP_USE_AVX */

/* Use the AVX2 instruction set (i386 and x86_64 only). */
...
/* Use the SSSE3 instruction set (i386 and x86_64 only). */
/* #undef SPANDSP_USE_SSSE3 */
